...
console = Console()
table = Table(title="🌤️  Current Weather Around the World (Real-time Data)", show_header=True, header_style="bold cyan")

table.add_column("City", style="bold yellow", no_wrap=True)
table.add_column("Temp (°F)", justify="right", style="bold red")
